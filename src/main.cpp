...
//
//                    CANDY CRISIS - Apple TV
//
// FEATURES:
// • Removed SDL in favor of native graphics APIs. (OpenGL ES, CoreGraphics)
// • Support for new input types.
//
// ETC:
// • Codebase platform-neutrality in jeopardy.
//


//
//                    CANDY CRISIS 1080p - OS X and Windows
//                        NOT YET RELEASED
//
// FEATURES:
// • Converted codebase from 640x480 resolution to 1920x1080.
//

//
//                    CANDY CRISIS TRUE-COLOR - OS X and Windows
//                        NOT YET RELEASED
//
// FEATURES:
...
char            candyCrisisResources[1024];
static MBoolean needsRefresh = false;
...
{
    InitLevelData( "CandyCrisisLevels" );
...
void Initialize(void)
{
...
#if __APPLE__ || defined(linux)
    {
        ...
        snprintf(candyCrisisResources, sizeof(candyCrisisResources), "%sCandyCrisisResources/", basePath ? basePath : "");
        SDL_free(basePath);
    }
#endif
    ...
    g_dropLockEnabled = Platform_IsTouchDevice();
	...
	{
		Platform_Error("IMG_Init failed");
	}

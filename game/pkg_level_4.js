  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/Users/johnstiles/CandyCrisis/build-web/pkg_level_4.data';
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_/Users/johnstiles/CandyCrisis/build-web/pkg_level_4.data');
      }
      Module['addRunDependency']('datafile_/Users/johnstiles/CandyCrisis/build-web/pkg_level_4.data');
